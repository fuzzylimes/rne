...
JOBS = [
    ...
    ("Initial D", 1, 3, None, "failed",      None, None, None, "HandBrake exit 1: invalid source", "2026-05-04 20:00:00"),
    ("Initial D", 1, 2, None, "done",        100,  None, None, None, "2026-05-04 18:02:00"),
    (None, None, None, "The Silence of the Lambs", "interrupted", None, None, None, "worker did not finish; reconciled on startup", "2026-05-04 10:00:00"),
]
...
def seed() -> None:
    ...
    conn.execute("UPDATE worker_status SET state='encoding', last_seen=CURRENT_TIMESTAMP WHERE id=1")
    ...
    for show, season, episode, movie, status, pct, fps, eta, err, finished in JOBS:
        conn.execute(
            ...
            (
                ...
                ARGS, status, pct, fps, eta, err, finished,
